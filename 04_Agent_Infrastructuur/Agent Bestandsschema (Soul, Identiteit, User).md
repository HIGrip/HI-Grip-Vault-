...
**Let op (Obsidian):** omdat alle agents een bestand met dezelfde naam hebben (meerdere keren `soul.md`, `identiteit.md`, `user.md`), werkt een kale `[[soul]]`-wikilink niet betrouwbaar — Obsidian weet dan niet welke je bedoelt. Verwijs binnen een agent-map gewoon in platte tekst naar "soul.md in deze map", en gebruik voor links van buitenaf het volledige pad, bv. `[[02_Partnership_Agent/soul]]`.
