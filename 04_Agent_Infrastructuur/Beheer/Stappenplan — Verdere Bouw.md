...
- [ ] Website Agent's 4 sub-agent-skills (SEO, Design, Website Copy, Conversie & Analyse) en Content Agent's Video & Visuele Productie Agent staan op "in ontwikkeling" (werkende `/`-skills sinds 2026-08-09) — nog niet "actief" en nog nooit ingezet. De nieuwe live-site-check hierboven is een eerste stap richting het echt gebruiken van Conversie & Analyse Agent; de overige 4 skills wachten nog.
