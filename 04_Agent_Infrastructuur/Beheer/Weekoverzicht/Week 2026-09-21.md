...
> Property 476032345, vergeleken met 07-09 t/m 13-09. Wordt vanaf nu elke week standaard toegevoegd — zie [[Denzel Weekoverzicht — Routine]] stap 6.

**Verkeer:** 123 sessies (vorige week 87, +41%), 98 gebruikers (75, +31%). **Maar ~60 daarvan zijn vrijwel zeker bots:** 51 sessies uit de VS (44 Direct/desktop met 4,5% engagement, 7 Direct/mobiel met 0%) plus 7 uit China. Echt verkeer (NL) = 52 sessies. Filter dit in GA4 (data-filter of segment "Land = Nederland") voordat je op sessies of engagement stuurt.

**Waar komen ze vandaan (sessies):** Direct 88 (grotendeels bots), Organic Search 24 (google 23, bing 1; engagement 42%, gem. 2 min), Organic Social 4, Referral 4 (l.instagram.com 4 — linktr.ee 2 — myshopify-preview 2), E-mail 1 (SendWILL), Unassigned 2. Instagram levert dus maar een handvol bezoekers, Google is de enige echte groeikanaal.

**Waar landen ze:** homepage 42 sessies (bounce 48%, 3 min gem. — beide orders begonnen hier), 12× "(not set)" (0 seconden, bots), /en 7, /collections/all 5, productpagina's performance-grip-socks-2-0 wit en zwart 5 elk, hi-grip-gripsokken-1 4, blog "de wetenschap achter gripsokken" 3 (100% bounce), /collections/gripsokken 3 (100% bounce), over-ons 3. **/collections/all krijgt meer landingen dan /collections/gripsokken** — de nieuwe menuknop trekt dus nog niet.

**Apparaat:** mobiel 39 sessies (64% bounce) → beide orders; desktop 84 sessies (80% bounce, bijna allemaal bots) → 0 orders. Vorige week was mobiel 55 sessies.
...
**Waar haken ze af:** (1) *vóór een product:* van 98 gebruikers bekijken maar 24 een product (25%) — de collectiepagina's zijn de eerste leak (view_item_list daalde van 28 naar 17 gebruikers). (2) *product → cart:* 24 → 9 gebruikers (38%), verbeterd t.o.v. vorige week (19%). (3) *checkout:* 7 gebruikers begonnen, maar maar 1 kwam bij betaalgegevens en 2 rekenden af (29%) — tussen begin_checkout en betaalstap gaat de meeste weg (adres/verzendkosten-stap), benchmark is ~80% afronding. Volume blijft klein (<100 echte sessies), dus indicatief, geen trend.

**Conclusie:** de €0-week is doorbroken (2 orders, beide mobiel, 1× Direct + 1× Google organic). Prioriteit blijft de stap begin_checkout → betaling; Zuko (zie AI-ontwikkelingen punt 3) of een testbestelling op mobiel is daar de aangewezen volgende stap.
