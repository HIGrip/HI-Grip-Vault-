...
## Autonomie per taak
> Nog niet vastgesteld. Voor de Website Agent is dit ingevuld via een interactief grenzen-formulier met lars (zie [[Agent Takenverdeling & Grenzen]]). Datzelfde gesprek moet nog gevoerd worden voor de Content Agent.
